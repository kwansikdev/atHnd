...
export function AreaAddReleaseDate() {
        ...
        return (
          <FormItem className="flex flex-col">
            <div className="flex items-start justify-between">
              <FormLabel>
                출시일<span className="text-red-500 ml-1">*</span>
              </FormLabel>
                ...
                <Calendar
                  ...
                  onSelect={(selectedDate) => {
                    if (selectedDate) {
                      ...
                      form.setValue("release_year", Number(year));
                      form.setValue("release_month", Number(month));
                    }
                  }}
                  initialFocus
                />
